        ...
        <div className="bg-white dark:bg-neutral-800 p-8 rounded-3xl border border-neutral-200 dark:border-neutral-700 shadow-xl shadow-neutral-200/20 max-w-lg mx-auto">
            ...
            <form onSubmit={handleWithdraw} className="space-y-6">
                ...
                <button
                    ...
                    className="w-full bg-blue-600 hover:bg-blue-700 disabled:opacity-50 disabled:bg-neutral-200 dark:disabled:bg-neutral-800 disabled:text-neutral-400 disabled:cursor-not-allowed text-white py-4 rounded-2xl font-bold text-lg shadow-lg shadow-blue-500/25 transition-all active:scale-[0.98] flex items-center justify-center gap-2"
                >
                    {isSubmitting ? (
                        <>
